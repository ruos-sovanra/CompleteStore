...
import {useUploadCategoryImageMutation, useUploadImageMutation} from "@/redux/service/product";
...
export default function UploadPage() {
    ...
    const[uploadCategoryImage,{data,error}]=useUploadCategoryImageMutation();
    ...
    const handleUploadImage = async (file:any, name:any) => {
        ...
        try {
            const response = await uploadCategoryImage({ data: formData }); // Correct way to call the mutation function
        ...
        <main className='h-screen grid place-content-center'>
            ...
            <Formik
                ...
                onSubmit={async (values:any) => {
                    ...
                    const icon = values.fileCategory;
                    handleUploadImage(icon, name);
